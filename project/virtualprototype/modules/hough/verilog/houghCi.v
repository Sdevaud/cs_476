module houghCi #(parameter [7:0] customInstructionId = 8'hA7 )
  ...
  assign rhoA = sobelBinValueA ?(xA * cosA + yA * sinA) + 32'sd128 : 32'sd205056; // This is done for rounding
  assign rhoB = sobelBinValueB ?(xB * cosB + yB * sinB) + 32'sd128 : 32'sd205056; // This is done for rounding
